...
const TEMPLATES = [
{
  ...
  descAr: 'مجمع محلات تجارية من دور واحد بواجهات زجاجية، وممرات مظلّلة، ومواقف سيارات كافية — مصمم وفق اشتراطات الارتداد ومساحات القطع في السعودية.',
...
},
{
  ...
  descAr: 'أروقة تجارية في الدور الأرضي مع طوابق مكتبية وسكنية أعلاها، وسطح مرافق علوي، وواجهة من الحجر والزجاج تليق بمواقع التكثيف الحضري.',
  tagEn: 'Urban Mixed-Use',
  tagAr: 'مشروع حضري متعدد الاستخدامات',
  accentColor: '#8a7a6a',
  images: [
...
},
{
  ...
  descAr: 'مبنى مكتبي بواجهة زجاجية ستائرية، بهو رئيسي مزدوج الارتفاع، وساحة أمامية منسّقة، وطوابق مصممة لتجهيزات مرنة للمستأجرين.',
    ...
    <section
      ...
      <div className="px-6 md:px-16 lg:px-24 mb-16 md:mb-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-5 border hidden" style={{ borderColor: cat.color + '99' }}>
